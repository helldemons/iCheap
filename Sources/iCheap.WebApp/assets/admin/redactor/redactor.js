...
var RLANG = {
    ...
    fontcolor: 'Màu chữ',
    backcolor: 'Màu nền',
    unorderedlist: 'Bỏ sắp xếp List',
    orderedlist: 'Sắp xếp List',
    outdent: 'Hủy thụt lề',
    indent: 'Thụt lề',
    cancel: 'Thoát',
    insert: 'Chèn',
    ...
    insert_row_above: 'Thêm dòng bên trên',
    insert_row_below: 'Thêm dòng bên dưới',
    ...
    left: 'Trái',
    right: 'Phải',
    image_web_link: 'Liên kết hình ảnh web',
    text: 'Văn bản',
    mailto: 'Email',
    web: 'URL',
    ...
    align_left:	'Căn lề bên trái',
    align_center: 'Căn giữa',
    align_right: 'Căn lề phải',
    align_justify: 'Căn đều trái phải',
    horizontalrule: 'Chèn gạch ngang',
    deleted: 'Gạch bỏ',
    anchor: 'Anchor',
    link_new_tab: 'Mở link trên tab mới',
    underline: 'Gạch dưới',
    alignment: 'Căn lề'
		...
		this.opts = $.extend({
			...
			modal_table: String() +
				...
				'<div id="redactor_modal_footer">' +
					...
					'<a href="javascript:void(null);" class="redactor_modal_btn redactor_btn_modal_close uniformBtn">' + RLANG.cancel + '</a>' +
				'</div>',
